...
function qd_add() {
    ...
    console.info(document.getElementById("file-add").files[0]);
    ...
    $.ajax({
        type: "post",
        url: "../usdt/brunews/SysNewsInsert",
        async: true,
        dataType: "json",
        beforeSend: function (xhr) {
            xhr.setRequestHeader('Authorization', token);
...
function qd_update() {
    ...
    $.ajax({
        type: "post",
        url: "../usdt/brunews/SysNewsUpdate",
        async: true,
        dataType: "json",
        beforeSend: function (xhr) {
            xhr.setRequestHeader('Authorization', token);
